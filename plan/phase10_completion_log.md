# Phase 10: Frontend Foundation — Walkthrough
...
Next.js 14 frontend with Tailwind CSS, Singapore colors, and TypeScript types.
...
| File | Purpose |
|------|---------|
| [tailwind.config.ts](file:///home/project/nexuscore/frontend/tailwind.config.ts) | **Singapore colors** |
| [client.ts](file:///home/project/nexuscore/frontend/src/lib/api/client.ts) | Axios + auth |
| [models.ts](file:///home/project/nexuscore/frontend/src/types/models.ts) | TypeScript types |
| [providers.tsx](file:///home/project/nexuscore/frontend/src/lib/providers.tsx) | React Query |
| [layout.tsx](file:///home/project/nexuscore/frontend/src/app/layout.tsx) | Root layout |
...
- User, Organization (UEN, GST)
- Invoice (GST fields, IRAS codes)
- Lead (UTM tracking)
- DSARRequest (SLA status)
...
Phase 11: Frontend Pages (Marketing, Auth, App pages)
